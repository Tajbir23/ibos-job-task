  ...
  return (
    <div className="flex min-h-screen">
      <div className="lg:w-2/3 w-full flex items-center justify-center">
        <div className="bg-[#FAFAFA] rounded-sm p-5 w-full md:w-[400px]">
          <div>
            <h1 className="font-medium text-[32px]">Welcome Back!</h1>
            <p className="text-[16px] font-medium text-[#707070]">Enter your Credentials to access your account</p>
          </div>
          {/* signup form start */}
          ...
          <ProviderSIgnIn />
          <p className="text-center font-medium mt-5">Have an account? <Link to="/signup" className="text-blue-700">Sign Up</Link></p>
        </div>
      </div>
      <SideImage />
    </div>
